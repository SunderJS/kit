...
export function base (ALPHABET: string) {
  ...
  function encode (source: Uint8Array | Array<number>) {
...
/**
 * For values to be copied by a human, does not contain Il0O
 */
export const base58 = base("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz");

/**
 * Non-human friendly alphanumeric encoding
 */
